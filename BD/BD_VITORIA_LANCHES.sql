...
TB_TIPO_PRODUTO_DESC VARCHAR(32) NOT NULL UNIQUE
);
...
TB_PRODUTO_TIPO_PRODUTO_ID INT, 
...
TB_FUNCIONARIOS_USERS_ID INT NOT NULL,
TB_FUNCIONARIOS_NOME VARCHAR(128) NOT NULL,
TB_FUNCIONARIOS_TEL VARCHAR(32) NOT NULL,
TB_FUNCIONARIOS_ENDEREÇO VARCHAR(128) NOT NULL,
TB_FUNCIONARIOS_ENDEREÇO_NUM VARCHAR(16) NOT NULL,
TB_FUNCIONARIOS_SAL DECIMAL(10,2) NOT NULL,
TB_FUNCIONARIOS_DATA_ADIMISSAO DATE NOT NULL,
FOREIGN KEY (TB_FUNCIONARIOS_USERS_ID) REFERENCES TB_USERS(TB_USERS_ID)
); 
